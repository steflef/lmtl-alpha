...
(function (window, undefined) {
    ...
    L.Polyline.Draw = L.Handler.Draw.extend({
        ...
        _getLabelText:function () {
            ...
            if (this._markers.length === 0) {
                labelText = {
                    text:'Cliquez pour commencer à dessiner la ligne.'
                };
            } else {
    ...
    L.Polygon.Draw = L.Polyline.Draw.extend({
        ...
        _getLabelText:function () {
            var text;
            if (this._markers.length === 0) {
                text = 'Cliquez pour commencer à dessiner le polygone.';
            } else if (this._markers.length < 3) {
                text = 'Cliquez pour continuer à dessiner le polygone.';
            } else {
                text = 'Cliquez le premier point pour fermer le polygone.';
            }
            return {
                text:text
            };
    ...
    L.SimpleShape.Draw = L.Handler.Draw.extend({
        ...
        _onMouseDown:function (e) {
            ...
            this._updateLabelText({ text:'Relâcher le bouton pour terminer le dessin.' });
    ...
    L.Circle.Draw = L.SimpleShape.Draw.extend({
        ...
        _initialLabelText:'Cliquez et glisser pour dessiner le cercle.',
    ...
    L.Rectangle.Draw = L.SimpleShape.Draw.extend({
        ...
        _initialLabelText:'Cliquez et glisser pour dessiner le rectangle.',
    ...
    L.Control.Draw = L.Control.extend({
        ...
        options:{
            ...
            reset:{
                title:'Supprimer le filtre géographique'
            }
        },
        ...
        onAdd:function (map) {
            ...
            if (this.options.reset) {
               // this.handlers.reset = new L.Marker.Draw(map, this.options.reset);
                this._createButton(
                    this.options.reset.title,
                    className + '-reset',
                    container,
                    test=function(){
                        //console.log("CLEAR");
                    ...
                    test
                 //   this.handlers.reset.enable,
                 //   this.handlers.reset
                );
               // this.handlers.reset.on('activated', this._disableInactiveModes, this);
            }
